            ...
            <div class="container">
                ...
                @if(count($content) ==0)
                    <div class="container text-center">
                        <h1>Voter panier est vide</h1>
                       <img src="https://media.giphy.com/media/26hkhPJ5hmdD87HYA/giphy.gif" alt="votre panier est vide">
                ...
                <table class="table table-bordered table-responsive-sm">
                    ...
                    <tr>
                        <td>
                            <img style="float: left; margin-right: 10px " width="110" class="rounded-circle img-thumbnail" src="{{asset('storage/uploads/'.$produit['attributes']['photo'])}}" alt="">

                            <div style="margin-top: 25px ">
                           {{$produit['name']}}<br> @if($produit['attributes']['size'])<strong>Taille: </strong>{{$produit['attributes']['size']->nom}}@endif
                                <br>
                                <a href="{{route('remove_produit_cart',['id'=>$produit['id']])}}">
                                    <i style="color: red" class="fa fa-trash"></i>
                                </a>
                            </div>
                        </td>
                        <td>
                        <form action="{{route('update_produit_cart',['id'=>$produit['id']])}}" method="post">
                            @csrf
