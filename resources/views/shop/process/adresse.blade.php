                    ...
                    <form action="{{route('commande_store_adresse')}}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 mb-4">
                                ...
                                <input type="text" class="form-control" id="nom" required name="nom" value="{{$adresse->nom ?? old('nom')}}">
                            </div>
                            <div class="col-md-3 mb-4">
                                <label for="telephone">Votre téléphone <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="telephone" required name="telephone" value="{{$adresse->telephone ?? old('telephone')}}">
                            </div>
                            <div class="col-md-3 mb-4">
                                <label for="email">Votre email <span class="text-danger">*</span></label>
                                <input type="email" class="form-control" id="email" required name="email" value="{{$adresse->email ?? old('email')}}">
                            </div>
                        </div>

                        <div class="mb-3">
                            <label for="adresse">Votre adresse <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="adresse" required name="adresse" value="{{$adresse->adresse ?? old('adresse')}}">
                        </div>

                        <div class="mb-3">
                            <label for="address2">Complément d'adresse<span class="text-muted">(Optional)</span></label>
                            <input type="text" class="form-control" id="adresse2" name="adresse2" value="{{$adresse->adresse2 ?? old('adresse2')}}">
                        </div>

                        <div class="row">
                            <div class="col-md-3 mb-4">
                                <label for="ville">Votre ville <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="ville" required name="ville" value="{{$adresse->ville ?? old('ville')}}">
                            </div>

                            <div class="col-md-3 mb-3">
                                <label for="code_postal">Votre code postal <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="code_postal" required name="code_postal" value="{{$adresse->code_postal ?? old('code_postal')}}">
                            </div>
