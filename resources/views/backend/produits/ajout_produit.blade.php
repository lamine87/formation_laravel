            ...
            <form action="{{route('backend_produit_store')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" id="nom" name="nom" value="{{old('')}}">
                    </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select class="form-control form-control-lg" id="categorie_id" name="categorie_id">
                            ...
                            <option {{old('categorie_id') == $categorie->id ? "selected" : ""}}value="{{$categorie->id}}">{{$categorie->nom}}</option>
                            @endforeach
                        </select>
                    </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <select multiple class="form-control" name="produits_recommandes[]" id="produits_recommandes">
                            @foreach($produits_recommandes as $produit_recommande)
                            <option value="{{$produit_recommande->id}}">{{$produit_recommande->nom}}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
